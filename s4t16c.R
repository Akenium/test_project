...
fit_brm_S4_t16c_NCIf <- brm(formula = gig_abs ~ 
                       ...
                       family=gaussian(), 
                       prior=prior_brms, 
                       iter=1200, chains=4, cores=16, seed=42, control=list(adapt_delta=0.99, max_treedepth=15))


save(fit_brm_S4_t16c_NCIf, file="fit_brm_S4_t16c_NCIf.RData")
